...
use App\Http\Requests\StoreTestpageRequest;
...
class TestpageController extends Controller
{
    public function index()
    {
        ...
        $testpage = InsuranceDetails::inactive()->latest('date_start')->get();
        
        // $insurances = InsuranceDetails::all();

        return view('admin.testpage.index', compact('testpage'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.testpage.create', compact('company','agent','insuranceCompany'));
    }

    public function store(StoreTestpageRequest $request)
    {
        ...
        //insert into insurance table
        $insurance = Testpage::create($insurance_table);
        ...
        $insurance_details = TestpageDetails::create($insurance_details_table);
        ...
        return response()->json(['url'=>url('/admin/testpage')]);
    }
    ...
    public function show(Insurance $insurance)
    {
        ...
        return view('admin.testpage.show',compact('insurance'));
    }
