...
@can('insurance_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route("admin.testpage.create") }}">
            ...
            <table class=" table table-bordered table-striped table-hover datatable datatable-insurance">
                ...
                @if(!empty($insurances))
                    ...
                    <tr data-entry-id="{{ $ins->id }}">
                        ...
                        <td>
                            @can('insurance_show')
                                <a class="btn btn-xs btn-primary" href="{{ route('admin.testpage.show', $ins->insurances->id) }}">
                                    {{ trans('global.view') }}
                                </a>
                            @endcan

                            @can('insurance_edit')
                                <a class="btn btn-xs btn-info" href="{{ route('admin.testpage.edit', $ins->insurances->id) }}">
                                    {{ trans('global.edit') }}
                                </a>
                            @endcan
